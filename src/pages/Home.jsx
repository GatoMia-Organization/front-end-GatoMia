...
export default function Home() {
  ...
  return (
    <div className="home-page">
      {/* HERO */}
      <section className="bg-light text-dark py-5 text-center shadow-sm rounded mb-5">
        <div className="container">
          <h1 className="fw-bold display-5">Bem-vindo ao Gato Mia</h1>
          <p className="lead mb-4">
            Juntos pela proteção e bem-estar das crianças.  
            Informação, prevenção e acolhimento em um só lugar.
          </p>
